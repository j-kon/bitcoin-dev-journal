...
export const journalEntries: JournalEntry[] = [
  {
    ...
    summary:
      "Mapped the FFI surface before reacting to the diff so the review could stay anchored in interface clarity instead of surface noise.",
    learned:
      "The useful review move was not just spotting what changed, but understanding which naming and shape decisions would be hardest to undo later.",
    confused:
      "I had to slow down around where Rust-side intent gets flattened once it crosses the FFI boundary.",
    next:
      "Keep logging review notes in a way that shows how reading other people’s code sharpens judgment before writing more of my own.",
  ...
  },
  {
    ...
    summary:
      "Read through the issue thread and the surrounding product flow first so the eventual code could respond to the actual problem instead of the first phrasing of it.",
    learned:
      "Issue exploration is part of contribution, not dead time before contribution. It is where a lot of the quality comes from.",
    confused:
  ...
  },
  {
    ...
    summary:
      "Used BIP-86 as a way to tighten my mental model around single-key taproot paths and to connect abstract reading back to the wallet product work I am actively doing.",
    learned:
      "Reading clicked more once I treated it like infrastructure for product decisions rather than isolated theory.",
    confused:
      "I still want to keep sharpening how BIP-level ideas show up in the practical tradeoffs of app-facing wallet systems.",
    next:
  ...
  },
  {
    ...
    summary:
      "Took a concept that had felt fuzzy and wrote it down in plain language so it would stay reusable instead of fading after the first moment of understanding.",
    learned:
      "A written reflection is often the step that converts borrowed understanding into my own understanding.",
    next:
      "Keep turning confusing wallet concepts into short public notes that can support later implementation and grant narratives.",
  ...
  },
  {
    ...
    summary:
      "Closed the loop between app-building work and upstream Bitcoin study so product progress did not live in a separate narrative from open-source progress.",
    learned:
      "The strongest product changes happen when I can point to the Bitcoin concept or code-reading trail that informed them.",
    next:
      "Make each shipped product improvement legible as part of the same proof-of-work story as PR reviews, issues, and reading notes.",
